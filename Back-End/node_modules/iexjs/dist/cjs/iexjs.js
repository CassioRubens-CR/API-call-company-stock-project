...
const _LIST_OPTIONS = ["mostactive", "gainers", "losers", "iexvolume", "iexpercent"];
...
const _BATCH_TYPES = ["book", "chart", "company", "dividends", "earnings", "financials", "stats", "news", "peers", "splits", // limit 10
"intraday-prices", "effective-spread", "delayed-quote", "largest-trades", "previous", "price", "quote", "relevant", "volume-by-venue"];
...
const _getIEXCloudBase = async options => {
  ...
  return nodePonyfill(endpoint.href, {
    method: "GET",
    headers: {
...
class Client {
  constructor(options = {}) {
    ...
    if (this._token.startsWith("T") && version !== "sandbox") {
      throw IEXJSException("Using test key but attempting to connect to non-sandbox environment");
    }
...
const balanceSheet = async (symbol, period, last, {
  token,
  version,
  filter,
  format
...
Client.prototype.balanceSheet = function (symbol, period, last, {
  filter,
  format
} = {}) {
...
const cashFlow = async (symbol, period, last, {
  token,
  version,
  filter,
  format
...
Client.prototype.cashFlow = function (symbol, period, last, {
  filter,
  format
} = {}) {
...
const dividendsBasic = (symbol, timeframe, {
  token,
  version,
  filter,
  format
...
Client.prototype.dividendsBasic = function (symbol, timeframe, {
  filter,
  format
} = {}) {
...
const earnings = async (symbol, period, last, field, {
  token,
  version,
  filter,
  format
...
Client.prototype.earnings = function (symbol, period, last, field, {
  filter,
  format
} = {}) {
...
const financials = async (symbol, period, last, {
  token,
  version,
  filter,
  format
...
Client.prototype.financials = function (symbol, period, last, {
  filter,
  format
} = {}) {
...
const fundamentals = async (symbol, period, {
  token,
  version,
  filter,
  format
...
Client.prototype.fundamentals = function (symbol, period, {
  filter,
  format
} = {}) {
...
const incomeStatement = async (symbol, period, last, {
  token,
  version,
  filter,
  format
...
Client.prototype.incomeStatement = function (symbol, period, last, {
  filter,
  format
} = {}) {
...
Client.prototype.tenQ = function (symbol, options, {
  filter,
  format
} = {}) {
...
Client.prototype.tenK = function (symbol, options, {
  filter,
  format
} = {}) {
...
Client.prototype.twentyF = function (symbol, options, {
  filter,
  format
} = {}) {
...
Client.prototype.fortyF = function (symbol, options, {
  filter,
  format
} = {}) {
...
Client.prototype.news = function (symbol, last, {
  filter,
  format
} = {}) {
...
Client.prototype.marketNews = function (last, {
  filter,
  format
} = {}) {
